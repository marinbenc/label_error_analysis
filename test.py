...
def test(dataset, log_name, dataset_folder=None, save_predictions=False, viz=False, colorspace='rgb'):
    ...
    if dataset_folder is None:
      ...
      for fold, split in enumerate(splits):
        ...
        print(f'Fold {fold}: {len(valid_subjects)} subjects')
    else:
      dataset_args = {
    ...
    for fold, test_dataset in enumerate(datasets):
      ...
      checkpoint = models.get_checkpoint(log_name, fold)
